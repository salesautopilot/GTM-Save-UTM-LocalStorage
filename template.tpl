...

{
  ...
  "description": "Save UTM tags from the query parameters to the browser local storage.",
  "containerContexts": [
    "WEB"
  ]
}
...
for (var queryIndex = 0; queryIndex < queryParams.length; queryIndex++) {
  if (getQueryParam(queryParams[queryIndex])) {
    var utm = getQueryParam(queryParams[queryIndex]);
...
Created on 2023. 01. 10. 18:31:55
